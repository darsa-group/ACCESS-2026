...
Finally, the script `_preprocess.R` reads in a spreadsheet with contributors info using [googlesheets4](https://googlesheets4.tidyverse.org/), and creates the respective profiles under `content/people/`. 
