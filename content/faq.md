...
#### *So what's the point of submitting a project during application?!?*
It serves two purposes: to evaluate your existing understanding of the technologies we touch on during the course and how you foresee them applied to your research; and it allows us to get to know your interests and therefore create groups around a similar theme as well as assigning mentors based on their expertise. 

#### *Can I submit multiple project ideas in my application?*
Yes you can, but space is limited (1500 characters for the second "paragraph" of the application), so there is a trade-off in how much detail you can go into for each of your ideas. 

#### *Will we run an experiment during the course?*
Unfortunately no, due to the short duration we do not have the time to collect much data. You are more than welcome to bring your own data to explore during the course though!
...
There is decent, but not excellent disability access. A person in wheelchair will be able to access the house via a concrete ramp, and the meeting room is situated on the ground floor, so no stairs there. One room on the ground floor is fairly easy to access, with a wheelchair accessible bathroom just outside.
